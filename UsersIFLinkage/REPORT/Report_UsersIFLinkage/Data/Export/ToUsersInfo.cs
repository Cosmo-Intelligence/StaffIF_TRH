...
using Report_UsersIFLinkage.Data.Export.Common;
using Report_UsersIFLinkage.Util;

namespace Report_UsersIFLinkage.Data.Export
{
    /// <summary>
    /// ユーザ情報連携I/Fテーブル処理
    /// </summary>
        ...
        public static bool UpdateResult(DataRow tousersRow, OracleDataBase db)
        {
            try
            {
                ...
                db.ExecuteQuery(ConstQuery.TOUSERSINFO_UPDATE,
                        ...
                        tousersRow["TRANSFERRESULT"].ToString(), tousersRow["TRANSFERTEXT"].ToString(), tousersRow["MESSAGEID1"].ToString());

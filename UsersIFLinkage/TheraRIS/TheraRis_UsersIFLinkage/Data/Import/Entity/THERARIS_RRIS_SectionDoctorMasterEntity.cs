...
namespace TheraRis_UsersIFLinkage.Data.Import.Entity
{
    ...
    class THERARIS_RRIS_SectionDoctorMasterEntity
    {
        ...
        // Y_Higuchi -- add --
        /// <summary>
        /// 治療医登録対象フラグ（0:OFF、1:ON）
        /// </summary>
        private int? treat_doctors_flg = null;

        /// <summary>
        /// 治療医登録対象フラグ（0:OFF、1:ON）
        /// </summary>
        public int? Treat_doctors_flg
        {
            get { return treat_doctors_flg; }
            set { treat_doctors_flg = value; }
        }
        // Y_Higuchi -- add --
        ...
        // Y_Higuchi -- add --
            strText += " treat_doctors_flg=" + treat_doctors_flg;
        // Y_Higuchi -- add --
            return strText;
        }
